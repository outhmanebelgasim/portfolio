    ...
    <section id="contact" className="relative bg-secondary/30 px-4 py-24">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[1fr_1.2fr]">
          <div className="rounded-2xl border border-border/60 bg-card/80 p-6 text-left sm:p-8">
            ...
            <div className="space-y-5">
              {contactItems.map((item) => {
                ...
                return (
                  <div
                    key={item.label}
                    className="flex items-start gap-4 rounded-xl border border-border/40 bg-background/30 p-4">
                    ...
                    <div className="min-w-0">
                      ...
                      {item.href ? (
                        <a
                          href={item.href}
                          className="mt-1 block break-words text-base text-foreground/90 transition-colors hover:text-primary">
                          {item.value}
                        </a>
                      ) : (
                ...
                {externalLinks.map((link) => {
                  ...
                  return (
                    <a
                      ...
                      className="inline-flex items-center justify-between gap-2 rounded-full border border-border/60 px-4 py-2.5 text-sm text-foreground/80 transition-colors hover:border-primary/40 hover:text-primary"
          ...
          <div className="rounded-2xl border border-border/60 bg-card/80 p-6 text-left shadow-xs sm:p-8">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full rounded-md border border-input bg-background px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full resize-y rounded-md border border-input bg-background px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary"
